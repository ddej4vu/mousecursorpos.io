...
class b extends HTMLElement {
    ...
    createRenderRoot() {
        ...
        return S$1(t, this.constructor.elementStyles),
        t
    }
    connectedCallback() {
    ...
    requestUpdate(t, s, i, e=!1, r) {
        if (void 0 !== t) {
            if (i ??= this.constructor.getPropertyOptions(t),
    ...
    performUpdate() {
        ...
        if (!this.hasUpdated) {
            ...
            if (t.size > 0)
                for (const [s,i] of t)
                    !0 !== i.wrapped || this._$AL.has(s) || void 0 === this[s] || this.C(s, this[s], i)
        }
        let t = !1;
        const s = this._$AL;
        try {
...
const t = globalThis
  , i = t.trustedTypes
  , s$1 = i ? i.createPolicy("lit-html-desktop", {
    createHTML: t => t
}) : void 0
  , e = "$lit$"
...
const P = (t, i) => {
    ...
    for (let i = 0; i < s; i++) {
        const s = t[i];
        let a, u, d = -1, y = 0;
        for (; y < s.length && (c.lastIndex = y,
        u = c.exec(s),
        null !== u); )
            y = c.lastIndex,
            c === f ? "!--" === u[1] ? c = v : void 0 !== u[1] ? c = _ : void 0 !== u[2] ? ($.test(u[2]) && (r = RegExp("</" + u[2], "g")),
            c = m) : void 0 !== u[3] && (c = m) : c === m ? ">" === u[0] ? (c = r ?? f,
            d = -1) : void 0 === u[1] ? d = -2 : (d = c.lastIndex - u[2].length,
            a = u[1],
            c = void 0 === u[3] ? m : '"' === u[3] ? g : p) : c === g || c === p ? c = m : c === v || c === _ ? c = f : (c = m,
            r = void 0);
        const x = c === m && t[i + 1].startsWith("/>") ? " " : "";
        l += c === f ? s + n : d >= 0 ? (o.push(a),
        s.slice(0, d) + e + s.slice(d) + h + x) : s + h + (-2 === d ? i : x)
    }
...
class V {
    constructor({strings: t, _$litType$: s}, n) {
        ...
        const u = t.length - 1
          , d = this.parts
          , [f,v] = P(t, s);
        if (this.el = V.createElement(f, n),
...
function N(t, i, s=t, e) {
    ...
    return h?.constructor !== o && (h?._$AO?.(!1),
    void 0 === o ? h = void 0 : (h = new o(t),
    h._$AT(t, s, e)),
...
class S {
    ...
    u(t) {
        ...
        for (; void 0 !== l; ) {
            if (o === l.index) {
                let i;
                2 === l.type ? i = new M(h,h.nextSibling,this,t) : 1 === l.type ? i = new l.ctor(h,l.name,l.strings,this,t) : 6 === l.type && (i = new L(h,this,t)),
                this._$AV.push(i),
                l = s[++n]
            }
            o !== l?.index && (h = E.nextNode(),
            o++)
        }
        return E.currentNode = r$1,
        e
    }
    p(t) {
        let i = 0;
        for (const s of this._$AV)
            void 0 !== s && (void 0 !== s.strings ? (s._$AI(t, s, i),
            i += s.strings.length - 2) : s._$AI(t[i])),
            i++
    }
}
class M {
    ...
    get parentNode() {
        ...
        const i = this._$AM;
        return void 0 !== i && 11 === t?.nodeType && (t = i.parentNode),
        t
    }
    get startNode() {
        return this._$AA
    ...
    _$AI(t, i=this) {
        t = N(this, t, i),
        c(t) ? t === T || null == t || "" === t ? (this._$AH !== T && this._$AR(),
        this._$AH = T) : t !== this._$AH && t !== w && this._(t) : void 0 !== t._$litType$ ? this.g(t) : void 0 !== t.nodeType ? this.$(t) : u(t) ? this.T(t) : this._(t)
    }
    k(t) {
    ...
    _(t) {
        this._$AH !== T && c(this._$AH) ? this._$AA.nextSibling.data = t : this.$(r$1.createTextNode(t)),
        this._$AH = t
    }
    g(t) {
        const {values: i, _$litType$: s} = t
          , e = "number" == typeof s ? this._$AC(t) : (void 0 === s.el && (s.el = V.createElement(C(s.h, s.h[0]), this.options)),
        s);
        if (this._$AH?._$AD === e)
            this._$AH.p(i);
        else {
    ...
    _$AC(t) {
        ...
        return void 0 === i && A.set(t.strings, i = new V(t)),
        i
    }
    T(t) {
        ...
        let s, e = 0;
        for (const h of t)
            e === i.length ? i.push(s = new M(this.k(l()),this.k(l()),this,this.options)) : s = i[e],
            s._$AI(h),
            e++;
        e < i.length && (this._$AR(s && s._$AB.nextSibling, e),
        i.length = e)
    }
        ...
        if (notifyProps !== null) {
            ...
            for (const key of changedProperties.keys()) {
                if (notifyProps.has(key)) {
                    if (changedProperties.get(key) === undefined && indexableThis[key] === undefined) {
                        continue
                    }
                    this.fire(`${toDashCase(key.toString())}-changed`, {
...
export {CrLitElement, s as LitElement, i$2 as css, x as html, T as nothing, j as render};
