 ...
 */
    ...
    8984: function(t, e, i) {
        ...
        FormRating.onStarClick = function t(e) {
            var i = n(e.currentTarget), a = i.parents(".u-form-rating").find("input"), s, u = i.prevAll(o).length + 1;
            a.val(u)
        }
        ,
        ...
        FormRating.onLeave = function t(e) {
            var i = n(e.currentTarget), o, a = i.find("input").val();
            FormRating.selectStars(i, a)
        }
        ,
        FormRating.subscribe = function t() {
            var e = ".u-form .u-form-rating .u-form-rating-item";
            n(e).click(FormRating.onStarClick),
            n(e).hover(FormRating.onStarHover);
